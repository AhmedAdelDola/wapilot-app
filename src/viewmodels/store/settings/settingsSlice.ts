...
import { Theme } from '@/models/types/common/Theme';
...
const initialState: SettingsState = {
  baseUrl: 'omni.message-pro.com',
  installationUrl: 'https://omni.message-pro.com/',
  uiFlags: {
    isSettingUrl: false,
    isUpdating: false,
    isLocaleSet: false,
  ...
  webSocketUrl: 'wss://omni.message-pro.com/cable',
  theme: 'system',
  version: '',
  pushToken: '',
};
