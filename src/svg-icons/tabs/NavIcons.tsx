...
export const BellIcon = ({ filled = false }: IconProps) => (
...
export const InboxIcon = ({ filled = false }: IconProps) => (
  <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <Path
...
export const PhoneIcon = ({ filled = false }: IconProps) => (
  <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    <Path
...
export const GearIcon = ({ filled = false }: IconProps) => (
  <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
