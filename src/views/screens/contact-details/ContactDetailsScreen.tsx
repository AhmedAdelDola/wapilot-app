...
import { AttributeListType, CustomAttribute, GenericListType } from '@/models/types';
...
import { AttributeList } from '@/views/components';
...
import { contactLabelActions } from '@/viewmodels/store/contact/contactLabelActions';
import { getContactCustomAttributes } from '@/viewmodels/store/custom-attribute/customAttributeSlice';
import { selectContactById } from '@/viewmodels/store/contact/contactSelectors';
import { selectContactLabelsByContactId } from '@/viewmodels/store/contact/contactLabelSlice';
