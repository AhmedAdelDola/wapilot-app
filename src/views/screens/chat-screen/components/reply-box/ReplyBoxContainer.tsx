...
import {
  ...
  setMessageContent,
  setQuoteMessage,
} from '@/viewmodels/store/conversation/sendMessageSlice';
import { selectUserId, selectUserName, selectUserThumbnail } from '@/viewmodels/store/auth/authSelectors';
...
import { Agent, CannedResponse, Conversation } from '@/models/types';
...
import { getLastEmailInSelectedChat } from '@/viewmodels/store/conversation/conversationSelectors';
import { selectAssignableParticipantsByInboxId } from '@/viewmodels/store/assignable-agent/assignableAgentSelectors';
...
import {
  ...
  setOriginalContent,
  resetCopilot,
} from '@/viewmodels/store/copilot/copilotSlice';
import { executeCopilotAction, sendCopilotFollowUp } from '@/viewmodels/store/copilot/copilotActions';
import type { CopilotActionKey } from '@/models/types/Copilot';
