...
import { selectQuoteMessage, setQuoteMessage } from '@/viewmodels/store/conversation/sendMessageSlice';
...
export const QuoteReply = () => {
  ...
  const handleScrollToMessage = useCallback(() => {
    const messageIndex = messageListRef.current?.props.data?.findIndex(
      (item: Message | { date: string }) => ('id' in item ? item.id === quoteMessage?.id : false),
    );
