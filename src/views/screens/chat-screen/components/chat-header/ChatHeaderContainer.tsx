...
import { ConversationStatus } from '@/models/types/common/ConversationStatus';
import { ChatHeader } from './ChatHeader';
import { DashboardList } from './DropdownMenu';
import { ImageSourcePropType } from 'react-native';
import { SLAStatus } from '@/models/types/common/SLA';
import { evaluateSLAStatus } from '@chatwoot/utils';
import { resetSentMessage } from '@/viewmodels/store/conversation/sendMessageSlice';
import { selectAllDashboardApps } from '@/viewmodels/store/dashboard-app/dashboardAppSlice';
