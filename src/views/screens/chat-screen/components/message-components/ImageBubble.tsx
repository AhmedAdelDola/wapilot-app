...
import { useImageDimensions } from '@/viewmodels/hooks/useImageDimensions';
import type { ImageCellProps, ImageContainerProps } from '@/viewmodels/hooks/useImageDimensions';
