...
import { Channel, Message } from '@/models/types';
...
import { setQuoteMessage } from '@/viewmodels/store/conversation/sendMessageSlice';
          ...
          <Animated.View
            style={[
              tailwind.style(
                ...
                `${variant === MESSAGE_VARIANTS.EMAIL ? `max-w-[${EMAIL_WIDTH}px]` : `max-w-[${CHAT_MAX_WIDTH}px]`}`,
