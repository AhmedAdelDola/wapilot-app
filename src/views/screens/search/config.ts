...
import type { Message } from '@/models/types/Message';
import { SearchResultContactItem } from '@/views/screens/search/components/result-items/SearchResultContactItem';
import { SearchResultConversationItem } from '@/views/screens/search/components/result-items/SearchResultConversationItem';
import { SearchResultMessageItem } from '@/views/screens/search/components/result-items/SearchResultMessageItem';
...
import type { AppDispatch } from '@/viewmodels/store';
import type { SearchItem, SearchSectionType } from '@/viewmodels/store/search/searchTypes';
