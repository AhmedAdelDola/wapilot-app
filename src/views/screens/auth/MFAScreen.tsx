...
import { Button, VerificationCode } from '@/views/components';
import { useAnimatedShake } from '@/views/components/verification-code/hooks/use-animated-shake';
import type { StatusType } from '@/views/components/verification-code';
import { tailwind } from '@/theme';
import { useAppDispatch, useAppSelector } from '@/hooks';
import { resetSettings } from '@/viewmodels/store/settings/settingsSlice';
import { authActions } from '@/viewmodels/store/auth/authActions';
import { resetAuth, clearAuthError } from '@/viewmodels/store/auth/authSlice';
